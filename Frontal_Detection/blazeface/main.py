    ...
    while True:
        ...
        if results.multi_face_landmarks and len(results.multi_face_landmarks) == 1:
            ...
            for face_landmarks in results.multi_face_landmarks:
                ...
                line_width = 30  # adjust as desired

                # Draw the eye lines and parallel lines
                cv2.line(image, left_eye, right_eye, (0, 255, 0), thickness=2)
                ...
                length = 100
                x1 = int(mid_point[0] + length * math.cos(angle + math.pi / 2))
                y1 = int(mid_point[1] + length * math.sin(angle + math.pi / 2))
                x2 = int(mid_point[0] + length * math.cos(angle - math.pi / 2))
                y2 = int(mid_point[1] + length * math.sin(angle - math.pi / 2))
